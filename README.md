...
**[Launch it](https://thomasehardt.github.io/aether/)** · **[Read the guide](https://thomasehardt.github.io/aether/guide.html)** (what everything does, plus write-ups of a couple of the more interesting bugs along the way) · or open `aether-soundscape.html` locally.
